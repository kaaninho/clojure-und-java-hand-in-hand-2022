...
- heute
  - Markus Schlegel: Modellbasiertes UI-Design
  - Mike Sperber: Erlang/Elixir – Systeme, die laufen und laufen und laufen
- morgen:
  - Markus Schlegel: Wie man mithilfe hoher Kopplung Softwareprojekte sabotiert
